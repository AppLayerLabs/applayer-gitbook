---
description: The playground for AppLayer's future endeavours
---
...
Tokens on a testnet are usually distributed by *faucets* - apps or sites that distribute small amounts of said token to users for free (since tokens on a testnet have no inherent value, contrary to tokens on the mainnet which represent real money).
